...
| 1.3 | **Leg A.** Embeddings + SQLite bundle frozen | `corpus/manifest.sqlite`, `corpus/vectors.f32` | **Tylin** | ✅ | 1.1, 1.2 | Read-only bundle shipped with the app. Brute-force cosine in the route is fine at this size. |
