...
| 4.3 | Deploy the frozen build, run the eval once more, publish the score | **Tylin** | 🟡 | Deploy is Khadim's Vercel project and is live as of 2026-08-26. Stephen ran the URL eval against https://manifest-web-roan.vercel.app: 15/28 (53.6 percent), 6/6 traps, same ids as fixtures, recorded in `docs/FACTS.json` `eval_live`. Remaining: Tylin 0.13 if the 90 bar is to be measured on watsonx. |
