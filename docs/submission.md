...
- [x] Replace every `[FACTS: ...]` from the 2026-08-29 `scripts/facts.py` run (headline 165, 120+95 tests, eval 53.6 percent / 6 of 6 traps). Never by hand.
