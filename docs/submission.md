...
- [x] Replace every `[FACTS: ...]` from the 2026-08-27 `scripts/facts.py` run (headline 162, 116+81 tests, eval 53.6 percent / 6 of 6 traps). Never by hand.
